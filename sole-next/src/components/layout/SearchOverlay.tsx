                ...
                <div className="max-w-4xl mx-auto w-full">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {filtered.map((product) => {
                      ...
                      // Using 'any' cast here in case 'salePrice' was added loosely
                      const hasSale = (product as any).salePrice !== undefined;
                      const displayPrice = hasSale ? (product as any).salePrice : product.price;
